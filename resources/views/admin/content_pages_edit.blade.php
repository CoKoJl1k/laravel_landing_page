<div class="wrapper container-fluid">
	...
	<div class="form-group">	
		...
		<div class="col-xs-8">
			{!! Form::text('alias',$data['alias'],['class' => 'form-control','placeholder' => 'Введите название псевдонима ']) !!}
		</div>
	</div>
	...
	<div class="form-group">	
		...
		<div class="col-xs-8">
			{!! Form::textarea('text',$data['text'],['id'=>'editor','class' => 'form-control','placeholder' => 'Введите название текста ']) !!}
		</div>
	</div>
	...
	<div class="form-group">	
		...
		<div class="col-xs-8">
			...
			{!! Form::file('old_images',data['images'] !!}
		</div>
	</div>
	...
	<div class="form-group">	
		...
		<div class="col-xs-8">
			{!! Form::file('images',['class' => 'filestyle','data-buttonText' => 'Введите изображение ','data-buttonName'=>"btn-primary",'data-placeholder'=>"Файла нет"]) !!}
		</div>
	</div>
